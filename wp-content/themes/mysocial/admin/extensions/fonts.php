...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'mysocial' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'mysocial' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'mysocial' ),
		'cyrillic'     => __( 'Cyrillic', 'mysocial' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'mysocial' ),
		'devanagari'   => __( 'Devanagari', 'mysocial' ),
		'greek'        => __( 'Greek', 'mysocial' ),
		'greek-ext'    => __( 'Greek Extended', 'mysocial' ),
		'khmer'        => __( 'Khmer', 'mysocial' ),
		'latin'        => __( 'Latin', 'mysocial' ),
		'latin-ext'    => __( 'Latin Extended', 'mysocial' ),
		'vietnamese'   => __( 'Vietnamese', 'mysocial' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'mysocial' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'mysocial' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'mysocial' ),
