 ...
 * @since      1.0.0
 */
class MySocial_Newsletter_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( 'Display newsletter subscribe form.', 'mysocial' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'mysocial-newsletter',                                    // $this->id_base
			esc_html__( '&raquo; Newsletter', 'mysocial' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'form_code' ); ?>">
				<?php esc_html_e( 'Subscribe Form Code', 'mysocial' ); ?> <span style="display: block;color: #999;">See <a href="http://www.happythemes.com/demo/mysocial/wp-content/themes/mysocial/form-example.txt" target="_blank">example code</a>.</span>
			</label>
