 ...
 * @since      1.0.0
 */
class mysocial_Social_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-mysocial-social widget_social_icons',
			'description' => __( 'Display your social media icons.', 'mysocial' )
		);

		// Create the widget.
		parent::__construct(
			'mysocial-social',                        // $this->id_base
			__( '&raquo; Social Icons', 'mysocial' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'      => esc_html__( 'Follow Us', 'mysocial' ),
			'desc'       => esc_html__( 'Stay updated via social channels', 'mysocial' ),		
			'facebook'   => '',
			'twitter'    => '',
			'gplus'      => '',
			'pinterest'  => '',
