 ...
 * @since      1.0.0
 */
class mysocial_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-mysocial-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'mysocial' )
		);

		// Create the widget.
		parent::__construct(
			'mysocial-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'mysocial' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'mysocial' ),
			'limit'     => 5,
			'show_date' => true
		);
