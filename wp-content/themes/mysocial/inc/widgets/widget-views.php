 ...
 * @since      1.0.0
 */
class mysocial_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-mysocial-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'mysocial' )
		);

		// Create the widget.
		parent::__construct(
			'mysocial-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'mysocial' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'mysocial' ),
			'limit'     => 5,
			'show_date' => true
		);
