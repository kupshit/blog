...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'myshare' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'myshare' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'myshare' ),
		'cyrillic'     => __( 'Cyrillic', 'myshare' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'myshare' ),
		'devanagari'   => __( 'Devanagari', 'myshare' ),
		'greek'        => __( 'Greek', 'myshare' ),
		'greek-ext'    => __( 'Greek Extended', 'myshare' ),
		'khmer'        => __( 'Khmer', 'myshare' ),
		'latin'        => __( 'Latin', 'myshare' ),
		'latin-ext'    => __( 'Latin Extended', 'myshare' ),
		'vietnamese'   => __( 'Vietnamese', 'myshare' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'myshare' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'myshare' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'myshare' ),
